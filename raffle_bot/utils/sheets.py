...
Enable by setting GOOGLE_SHEETS_ENABLED=true in .env.
The sheet is expected to have these columns:
ID | Platform Username | Telegram ID | @Username | Amount | Tickets | Date | Time | Status | Processed At
"""
